...
const NO_CREATE_HAND_OVER = ({ user }) => {
    ...
    <div className="w-full px-4 py-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gray-50 px-6 py-3 border-t text-sm text-gray-500 flex justify-between flex-wrap gap-2">
          <span>📋 In System: <strong>{activeRecords.length}</strong> rows | Total GIS: <strong>{filteredData.length}</strong> rows | Alarms: <strong>{alarmCount}</strong></span>
